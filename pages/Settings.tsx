...
export const Settings: React.FC = () => {
  ...
  const saveCatName = (id: string) => {
    if (!tempCatName.trim() || !settings) return setEditingCatId(null);
  ...
  const handleChangePassword = () => {
    setPwdStatus({ msg: 'A alteração de senha deve ser feita diretamente no painel do Supabase.', type: 'error' });
    /* 
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-800 leading-relaxed">
                Atualmente, seus dados fundamentais (militares, escalas e configurações) estão sincronizados com o Supabase.
                Utilize os botões abaixo para gerar cópias de segurança locais ou restaurar dados de um arquivo externo.
              </p>
            </div>
          </div>
        </div>
